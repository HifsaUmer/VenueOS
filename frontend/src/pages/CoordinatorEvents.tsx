...
import { Plus, Search, Filter, Calendar, MapPin, Users, ChevronRight, Sparkles } from 'lucide-react';
...
export default function CoordinatorEvents() {
  ...
  return (
    <PageLayout
      title="Events"
      subtitle="Manage all events across the venue"
      icon={Sparkles}
      actions={
          ...
          events.map((event, index) => (
            ...
            >
              ...
              <div className="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between">
                ...
                <button className="flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-800 transition-colors group">
                  View Details
