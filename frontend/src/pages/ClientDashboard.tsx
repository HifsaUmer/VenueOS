    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border">
            <h3 className="text-lg font-medium mb-2">Pending Proposals</h3>
            <p className="text-3xl font-bold text-yellow-600">0</p>
            <Link to="/" className="text-blue-600 hover:underline mt-4 inline-block">Review →</Link>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm border">
            <h3 className="text-lg font-medium mb-2">Invoices</h3>
            <p className="text-3xl font-bold text-green-600">0</p>
            <Link to="/" className="text-blue-600 hover:underline mt-4 inline-block">View invoices →</Link>
          </div>
        </div>
      </main>
    </div>
